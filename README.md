...
Porterai-smart-delivery-time-predictor/
├── flask_app/
│   ├── app.py                     # Main Flask application & prediction routing
│   ├── model_utils.py             # ML inference pipeline & fallback physics engine
│   ├── static/                    # Static assets & stylesheets
│   └── templates/
│       └── index.html             # PORTER // ETA-NET telemetry dashboard
├── models/
│   └── trained_model.pkl          # Serialized neural network pipeline
├── notebooks/
│   └── model_training.ipynb       # Feature engineering & training notebook
├── requirements.txt               # Python package dependencies
├── package.json                   # NPM configuration
├── LICENSE.txt                    # Legal MIT license & copyright notice
